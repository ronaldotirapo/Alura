...
/*JavaScript es un lenguaje debilmente tipado (Weak typing), por lo que no es necesario definir el tipo de dato de la variable;
además es de tipado dinámico, pues se pueden cambiar el tipo de dato de las variables una vez hayan sido declarados,
